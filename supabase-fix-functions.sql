-- ============================================================================
-- Fix Supabase Cache Functions
-- Fixes the type casting error in the lock functions
-- ============================================================================
...
-- 2. Create acquire_cache_update_lock with FIXED type casting
-- ============================================================================
...
BEGIN
  ...
  SELECT
    ...
    (update_started_at IS NULL OR
     update_started_at < current_time - (lock_timeout_seconds * INTERVAL '1 second')) AS is_expired
...
SELECT acquire_cache_update_lock('test-client-verify', 'tasks') as lock_acquired;
...
-- Fix Complete
-- ============================================================================
-- The functions should now work correctly
-- You can now refresh your browser and the cache should work
-- ============================================================================
