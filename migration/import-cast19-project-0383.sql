-- =====================================================================
-- Import casting inventory for Project 0383, Cast #19
...
-- Existing inventory under Cast #19 is wiped first so re-running is safe.
-- The DO block fails fast if Cast #19 is missing or ambiguous (multiple
...
BEGIN
    ...
    WHERE project_number = '0383' AND casting_number = '19';

    IF v_count = 0 THEN
        RAISE EXCEPTION 'No casting #19 found for project 0383';
    ELSIF v_count > 1 THEN
        RAISE EXCEPTION 'Multiple casting #19 rows found for project 0383 (% rows). Specify phase_id manually.', v_count;
    END IF;
